...
public class AddressBook {
	...
	public void writeToCSVFile(String AddressBookName)
		...
		Path pathLoc = Paths.get("D:\\Capg_Bridgelabz\\AddressBook\\src\\main\\java\\AddressBookOutputFile");
	...
	public void writeToJsonFile(String AddressBookName) throws IOException {
		Path pathLoc = Paths.get("D:\\Capg_Bridgelabz\\AddressBook\\src\\main\\java\\jsonAddressBookOutputFile");
		if (Files.notExists(pathLoc))
			Files.createDirectory(pathLoc);

		String SAMPLE_JSON_FILE = "D:\\Capg_Bridgelabz\\AddressBook\\src\\main\\java\\jsonAddressBookOutputFile" + ".json";
		Gson gson = new Gson();
